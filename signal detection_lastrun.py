...
expName = 'string method'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\khush\\OneDrive\\Desktop\\psy 310\\signal detection\\signal detection_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), draggable=True, size=(0.2, 0.2), sf=5.0, phase=0.0,
