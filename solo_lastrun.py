...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\khush\\OneDrive\\Desktop\\psy 310\\SOLO PROJECT\\solo_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Instructions_2 = visual.TextStim(win=win, name='Instructions_2',
        text='Welcome to the experiment!\n\nYou will see faces showing different emotions: Happy, Neutral, Sad.\n\nPress:\nF = Happy\nG = Neutral\nH = Sad\n\nRespond as quickly and accurately as possible.\n\nPress SPACE to start.\n',
        font='Arial',
    ...
    reminder_text = visual.TextStim(win=win, name='reminder_text',
        text='F = Happy\nG = Neutral\nH = Sad\n',
        font='Arial',
        pos=(0, -0.6), draggable=False, height=0.04, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('condition file.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        Trial = data.Routine(
            name='Trial',
            components=[fixation, face_image, reminder_text, key_resp],
        )
        Trial.status = NOT_STARTED
        continueRoutine = True
        # update component parameters for each repeat
        face_image.setImage(faces)
        ...
        while continueRoutine:
            ...
            if face_image.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
            ...
            if reminder_text.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['f','g','h'], ignoreKeys=["escape"], waitRelease=False)
