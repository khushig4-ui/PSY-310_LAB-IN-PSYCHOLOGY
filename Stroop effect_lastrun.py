...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\khush\\Stroop effect_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Fixation = visual.ShapeStim(
        win=win, name='Fixation',units='norm', 
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('OneDrive/Pictures/Documents/Cond.xlsx'), 
        seed=None, 
    )
